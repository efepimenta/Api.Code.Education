...
(function () {
    ...
    t.k = function (a, c) {
        ...
        c = t.qc(c);
        d.X && d.X.call(a, c);
        if (e && !c.Ib() && c.bubbles !== l)t.k(e, c); else if (!e && !c.defaultPrevented && (d = t.getData(c.target), c.target[c.type])) {
            d.disabled = f;
    ...
    s.vc = function () {
        var a, c, d, e;
        a = this;
        if (c = this.options().children)if (t.g.isArray(c))for (var g = 0; g < c.length; g++)d = c[g], "string" == typeof d ? (e = d, d = {}) : e = d.name, a[e] = a.S(e, d); else t.g.Y(c, function (c, d) {
            d !== l && (a[c] = a.S(c, d))
        })
    };
    s.T = q("");
    ...
    s.e = function (a, c) {
        ...
        c.innerHTML || (this.u = t.e("div", {className: "vjs-control-content"}), this.xb = t.e("span", {
    ...
    s.Z = function (a) {
        if (37 == a.which || 40 == a.which)a.preventDefault(), this.Mc(); else if (38 == a.which || 39 == a.which)a.preventDefault(), this.Nc()
    };
    s.Xa = function () {
        t.o(document, "keyup", t.bind(this, this.Z))
    };
    ...
    t.I.prototype.e = function (a, c) {
        return t.t.prototype.e.call(this, "li", t.g.z({className: "vjs-menu-item", innerHTML: this.l.label}, c))
    };
    ...
    function Q(a, c, d) {
        ...
        a.eb = c;
        a.la = l;
        var e = t.g.z({source: d, parentEl: a.b}, a.l[c.toLowerCase()]);
    ...
    s.exitFullscreen = function () {
        var a = t.Oa.Eb;
        this.isFullscreen(l);
        if (a)document[a.exitFullscreen](); else this.n.Da() ? T(this, "exitFullScreen") : (this.Cb(), this.k("fullscreenchange"));
        return this
    };
        ...
        for (var c = 0, d = this.l.techOrder; c < d.length; c++) {
            ...
            if (g) {
                if (g.isSupported())for (var h = 0, k = a; h < k.length; h++) {
                    var n = k[h];
                    if (g.canPlaySource(n))return {source: n, n: e}
                }
    ...
    s.src = function (a) {
        ...
        t.g.isArray(a) ? U(this, a) : "string" === typeof a ? this.src({src: a}) : a instanceof Object && (a.type && !window.videojs[this.eb].canPlaySource(a) ? U(this, [a]) : (this.G.src = a.src, this.mc = a.type || "", this.J(function () {
            T(this, "src", a.src);
    ...
    function U(a, c) {
        ...
        d ? d.n === a.eb ? a.src(d.source) : Q(a, d.n, d.source) : (e = setTimeout(t.bind(a, function () {
            this.error({code: 4, message: this.s(this.options().notSupportedMessage)})
    ...
    t.ra.prototype.wa = function () {
        var a = new t.ha(this.c, {kc: "div"}), c = new t.qb(this.c, t.g.z({vertical: f}, this.l.xe));
        c.d("focus", function () {
    ...
    s.wa = function () {
        ...
        if (c)for (var d = c.length - 1; 0 <= d; d--)a.S(new t.nb(this.j(), {rate: c[d] + "x"}));
        return a
    };
    s.oa = function () {
    ...
    t.f = t.q.extend({
        i: function (a, c, d) {
            ...
            var e = c.source;
            d = c.parentEl;
            var g = this.b = t.e("div", {id: a.id() + "_temp_flash"}), h = a.id() + "_flash_api", k = a.l, k = t.g.z({
            ...
            t.Xc && this.J(function () {
                t.d(this.v(), "mousemove", t.bind(this, function () {
                    this.j().k({type: "mousemove", bubbles: l})
                }))
            });
    ...
    t.f.wd = {"video/flv": "FLV", "video/x-flv": "FLV", "video/mp4": "MP4", "video/m4v": "MP4"};
    t.f.Pc = {"rtmp/mp4": "MP4", "rtmp/flv": "FLV"};
    ...
    s.update = function () {
        if (0 < this.ca.length) {
            ...
            if (this.Ob === b || a < this.Ob || this.Wa <= a) {
                ...
                for (; ;) {
                    r = c[w];
                    if (r.xa <= a)e = Math.max(e, r.xa), r.Na && (r.Na = l); else if (a < r.startTime) {
    ...
    s.wa = function () {
        for (var a = this.c.textTracks(), c = 0, d = a.length, e, g, h = this.P = []; c < d; c++)if (e = a[c], e.K() == this.H)if (0 === e.readyState())e.load(), e.d("loaded", t.bind(this, this.wa)); else {
            g = e;
            break
        }
        a = this.Aa;
